...
public class TrybeGamesController
{
    ...
    {
        int users = database.Players.Count;
        Console.WriteLine("Digita seu nome caboquin");
        ...
        database.Players.Add(newUser);
        Console.WriteLine("Ta dentro caboquin");
    }
    ...
    public void AddGameStudio()
    {
        ...
        int gameStudiosCount = database.GameStudios.Count;
        gameStudiosCount++;
        Console.WriteLine("Digita o nome do novo estúdio caboquin");
        ...
        Console.WriteLine("Seu estúdio tá criado caboquin!");
    }

    // 3. Crie a funcionalidade de adicionar novo Jogo ao Banco de dados
    public void AddGame()
    {
        int gamesCount = database.Games.Count;
        gamesCount++;
        Console.WriteLine("Digita o nome do seu joguin fiote");
        string gameName = Console.ReadLine();
        Console.WriteLine("Digita a data seu caboquin!");
        string releaseDate = Console.ReadLine();
        Console.WriteLine("Digite o número correspondente a categoria do seu joguin");
        GameType gameTypeN = GameType.Action;
        Console.WriteLine("0 - Action \n 1 - Adventure \n 2 - Puzzle \n 3 - Strategy \n 4-Simulation  \n 5-Sports \n 6-Other");
        int indexOfType = Convert.ToInt32(Console.ReadLine());
        if (indexOfType == 0)
        {
            gameTypeN = GameType.Action;
        }
        else if (indexOfType == 1)
        {
            gameTypeN = GameType.Adventure;
        }
        else if (indexOfType == 2)
        {
            gameTypeN = GameType.Puzzle;
        }
        else if (indexOfType == 3)
        {
            gameTypeN = GameType.Strategy;
        }
        else if (indexOfType == 4)
        {
            gameTypeN = GameType.Simulation;
        }
        else if (indexOfType == 5)
        {
            gameTypeN = GameType.Sports;
        }
        else if (indexOfType == 6)
        {
            gameTypeN = GameType.Other;
        }
        else if (indexOfType < 0 || indexOfType > 6)
        {
            Console.WriteLine("Escreva um número entre 0 e 6");
            indexOfType = Convert.ToInt32(Console.ReadLine());
        }
        Game game = new()
        {
            Id = gamesCount,
